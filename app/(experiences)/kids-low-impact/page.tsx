...
export default function KidsLowImpactPage() {
  return (
    <ExperiencePageLayout
      ...
      callout="Suitable for boys and girls. Perfect for birthday parties. Call us to discuss the right setup for your group's age range."
      includedCards={[
        {
          icon: '🛡️',
      ...
      ctaHeading="Safe, Fun, and Seriously Exciting"
